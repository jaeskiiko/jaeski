...
constraint c_email_resto foreign key (c_email) references client_on(c_email)
);
...
constraint u_email_com foreign key (u_email) references user_on(u_email)				
...
constraint articleNo foreign key (articleNo) references community(c_articleNo)				
);						
...
constraint u_email_reply foreign key (u_email) references user_on(u_email),				
constraint articleNo_reply foreign key (articleNo) references community(c_articleNo)				
);		
...
constraint u_email_point foreign key (u_email) references user_on(u_email)				
);		
...
constraint reserv_no_history foreign key (reserv_no) references reserv(reserv_no)				
);						
